...
public class EntrerFragment extends Fragment {
    ...
    public static EntrerFragment newInstance(String param1) {
        EntrerFragment fragment = new EntrerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_entrer, container, false);
        ...
        action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View viewIn) {
                ...
                integrator.forSupportFragment(EntrerFragment.this).initiateScan();
            }
        });
        ...
        if (result != null) {
            if (result.getContents() == null) {
                ...
                builder.setPositiveButton("Entrer", new DialogInterface.OnClickListener() {
                    ...
                    {
                        showProgress(true);
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Variable_general.lien_entrer,
